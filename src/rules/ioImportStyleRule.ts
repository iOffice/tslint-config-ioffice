/* Note: this rule has been brought over from https://github.com/palantir/tslint/pull/4134
 * It seems that it will take some time for that to be merged and released as part of tslint
 * so we'll just go ahead and use it here for now. When that is merged in we can go ahead
 * and delete this rule along with its test file.
 */
/**
 * @license
